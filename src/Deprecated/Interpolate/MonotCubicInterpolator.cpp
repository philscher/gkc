...
vector<double>  MonotCubicInterpolator::get_xVector() const 
{
...
vector<double>MonotCubicInterpolator::get_fVector() const 
{
...
string MonotCubicInterpolator::toString() const 
{
...
pair<double,double>MonotCubicInterpolator::getMissingX() const throw(const char*)
{
  if( data.size() < 2) {
...
pair<double,double>MonotCubicInterpolator::getMaximumF() const throw(const char*) {
  if (data.size() <= 1) {
...
pair<double,double>MonotCubicInterpolator::getMinimumF() const throw(const char*) {
  if (data.size() <= 1) {
...
void MonotCubicInterpolator::computeInternalFunctionData() const { 
...
void MonotCubicInterpolator::chopFlatEndpoints(const double epsilon) {
...
//   
//
void MonotCubicInterpolator::shrinkFlatAreas(const double epsilon) {
...
void MonotCubicInterpolator::computeSimpleDerivatives() const {
...
void MonotCubicInterpolator::adjustDerivativesForMonotoneness() const {
...
void MonotCubicInterpolator::scaleData(double factor) {
