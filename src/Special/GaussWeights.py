...
integration = []
#integration.append( ("GaussLegendreWeights.h", "GAUSS_LEGENDRE_WEIGHTS_H_", p_roots) )
integration.append( ("GaussLaguerreWeights.h", "GAUSS_LAGUERRE_WEIGHTS_H_", "Laguerre", l_roots) )
#integration.append( ("GaussHermiteWeights.h" , "GAUSS_HERMITE_WEIGHTS_H_" , h_roots) )
#integration.append( ("GaussJacobiWeights.h" , "GAUSS_JACOBI_WEIGHTS_H_" , j_roots) )
#integration.append( ("GaussChebychevFirstWeights.h" , "GAUSS_CHEBYCHEV_FIRST_WEIGHTS_H_" , t_roots) )
#integration.append( ("GaussChebychevSecondWeights.h", "GAUSS_CHEBYCHEV_SECOND_JACOBI_WEIGHTS_H_" , u_roots) )

## Add radau and add labatto

for n in  integration :
  createGaussWeightsFile(n[0], n[1], n[2], n[3])
