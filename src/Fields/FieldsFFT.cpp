                                    ...
                                    CComplex Field0[Nq][NzLD][NkyLD][NxLD]) 
{
   ...
   fft->solve(FFT_X_FIELDS, FFT_SIGN::Forward, ArrayField0.data((CComplex *) Q));
   ...
   fft->solve(FFT_X_FIELDS, FFT_SIGN::Backward, ArrayField0.data((CComplex *) Field0));
                         ...
                         const int m, const int s, const bool gyroFields)  
{
   ...
   fft->solve(FFT_X_FIELDS, FFT_SIGN::Forward, &In[1][NzLlD][NkyLlD][NxLlD]);
   ...
   fft->solve(FFT_X_FIELDS, FFT_SIGN::Backward, &Out[1][NzLlD][NkyLlD][NxLlD]);
...
void FieldsFFT::getFieldEnergy(double& phiEnergy, double& ApEnergy, double& BpEnergy)
{
      ...
      if(parallel->Coord[DIR_VMS] == 0) {
            ...
            CComplex Field0[Nq][NzLD][NkyLD][NxLD])
        {
          ...
          fft->solve(FFT_X_FIELDS, FFT_SIGN::Forward, &Field0[1][NzLlD][NkyLlD][NxLlD]);
