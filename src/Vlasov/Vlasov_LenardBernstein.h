...
protected:   
  ...
  public:
       ...
       Vlasov_LenardBernstein(Grid *grid, Parallel *parallel, Setup *setup, FileIO *fileIO, Geometry<HELIOS_GEOMETRY> *geo, FFTSolver *fft) : Vlasov(grid, parallel, setup, fileIO, geo, fft) {
