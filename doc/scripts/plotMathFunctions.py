...
gplot(-3, 2,  func, "$\\Gamma_0(x)-\\Gamma_1$", "Bessel Function", "GK_G0mG1.png", 'loglin')
func = lambda x : ((1.-x)*scipy.special.i0e(x) + x * scipy.special.i1e(x))
gplot(-3, 2,  func, "$\\Delta_1 = (1-b) \Gamma_0(b) - b \\Gamma_1(b)$", "Bessel Function", "GK_Delta_1.png", 'loglin')
func = lambda x : x/(x+1.)
